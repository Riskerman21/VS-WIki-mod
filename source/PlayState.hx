...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		{
			case 'forest world':
				dialogue = CoolUtil.coolTextFile(Paths.txt('sparkle boom/dialogue/bf'));
		}
		...
		if (SONG.stage == null) {
			switch(storyWeek)
			{
				case 1: stageCheck = 'concert';
				//i should check if its stage (but this is when none is found in chart anyway)
			}
		} else {stageCheck = 'concert';}
	...
	{
		black = new FlxSprite(-1000, -1000).makeGraphic(FlxG.width * 5, FlxG.height * 5, FlxColor.BLACK);
	...
	function forestCamIn():Void
	{
		FlxTween.tween(FlxG.camera, {zoom: 0.9}, (Conductor.stepCrochet * 4 / 1000), {ease: FlxEase.quadInOut});
	}
		...
		if (generatedMusic)
			{
				...
				{	
					...
					if (!daNote.mustPress && daNote.wasGoodHit)
					{
						...
						if (goddessDrain && !daNote.isSustainNote)
						{
